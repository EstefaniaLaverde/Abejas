...
/**
 * Última etapa del turno: se roban 2 cartas del mazo y se añaden al final
 * de la mano. Si el mazo (incluyendo la segunda ronda con el compost) se
 * agota en este punto, la partida pasa directo a la ronda final de trueques
 * en vez de continuar con el siguiente jugador.
 */
